...
import { FindWhatUFound } from './Components/whatUFound'
import { Recomendations } from './Components/recomentation';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/findWhatYouFound' element={<FindWhatUFound></FindWhatUFound>}></Route>
        <Route path='/recomendations' element={<Recomendations></Recomendations>}></Route>
      </Routes >
      {/* <NameForm/> */}
      {/* <EssayForm/> */}
